...
function Layout() {
  ...
  return (
    ...
    >
      {/* banner */}
      <div className="w-full h-10 bg-red-500 text-center flex items-center justify-center fixed z-50">
        <span className="text-white font-bold">App is under maintenance. Please check back later.</span>
      </div>
      <Navheader />
      <Outlet />
      <Footer />
